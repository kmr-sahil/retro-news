...
export default function Navbar({change, setChange}) {
  ...
  return (
    <div className='flex flex-col my-[1rem] '>
        ...
        <a target='_blank' href='https://github.com/kmr-sahil/retro-news#readme' className='bg-[#737373] w-[100%] absolute left-0 top-0 overflow-hidden'>
          <p className='w-[100%] animate-marquee hover:pause hover:ease-in whitespace-nowrap text-[#e6e6e6] text-[12px] py-[2px]'> Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span> ------- Free news API not available in production. Please run the code locally or <span className='underline underline-offset-2'> view the demo </span></p>
        </a>
